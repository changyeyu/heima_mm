    ...
    function deleteById() {
        ...
        if(id.length >= 1) {
            if(confirm("确认要删除选中的记录吗？")) {
                ...
                location.href="${ctx}/system/role?operation=delete&id=" + idStr + "&page=" + currentPage;
            }
        } else {
            alert("请勾选待处理的记录");
        }
                ...
                <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                    ...
                    <tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
                        ...
                        <th class="text-center">
                            <button type="button" class="btn bg-olive btn-xs" onclick='location.href="${ctx}/system/role?operation=toEdit&id=${o.id}&page=${page.pageNum}"'>编辑</button>
