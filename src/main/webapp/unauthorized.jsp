    ...
    <section class="content">
        <div class="error-page">
           <div class="error-content" style="margin-left:0">
                ...
                <p>
                    没有访问权限, 你可以 <a href="${pageContext.request.contextPath}/system/user?operation=islogin">返回到后台首页</a> 或者通过搜索查询
                </p>

                <form class="search-form" action="${pageContext.request.contextPath}/system/user?operation=islogin">
